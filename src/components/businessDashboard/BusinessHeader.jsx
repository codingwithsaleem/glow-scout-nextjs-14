    ...
    <div className='container flex justify-between items-center py-4'>
         <div className="flex items-center gap-4">
            <Link href="/" className="ml-4 lg:ml-0">
              <h1 className="text-xl md:text-3xl font-bold text-green font-valky text-[#351120]">Glow Scout</h1>
          ...
          <div className="flex items-center gap-1">
            <Link href="/spas" className="ml-4 lg:ml-0">
              <h1 className="text-xl md:text-2xl font-light text-green font-raleway text-[#351120] italic">Go to your Spa Page</h1>
