...
const AnalyticsComponent = () => {
  return (
    ...
    <div className="bg-card text-card-foreground p-4 rounded-lg shadow-md grid-rows-2">
    ...
    <div className="bg-card text-card-foreground p-4 rounded-lg shadow-md col-span-2">
