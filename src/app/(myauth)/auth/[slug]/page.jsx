...
const AuthCommon = ({params}) => {
  ...
  return (
    ...
    <div className="bg-[#351120] text-white px-20 py-16 md:py-28  md:w-1/2 flex flex-col justify-center">
              <h1 className="text-3xl md:text-6xl font-light mb-4 font-raleway">REVEAL YOUR <br />BEAUTY WITH</h1>
    ...
    {
      slug === 'user' ? <SignupUser /> : slug === 'business' ? <SignupBusiness /> : slug === 'login' ? <Login /> : slug === 'forgot-password' ? <ForgotPassword /> : notFound()
    }
    </div>
</div>
  )
