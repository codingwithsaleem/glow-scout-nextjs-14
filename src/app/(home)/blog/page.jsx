  ...
  let dummyData = [
    {
      ...
      description: "Dive into the enchanting world of fall-inspired makeup trends. From warm hues to bold lip colours, discover the latest beauty trends that will elevate your autumn beauty routine.",
    },
    {
...
<div className="container py-20 md:mt-6 font-raleway  mb-4">
  ...
  <div className="text-center pb-5">
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-4 py-4'>
        <div className=' '>
        <TreatmentCard image='/images/blog/blog-1.png' imageAlt='Featured Blog' label='Featured Blog'/>
        </div>
        <div className='flex justify-center items-start flex-col gap-4 p-5'>
        <h2 className="text-2xl md:text-4xl font-light">10-Must Have Skin <br /> Care Products for <br /> Radiant Skin</h2>
        <p className="mt-2 text-lg">
